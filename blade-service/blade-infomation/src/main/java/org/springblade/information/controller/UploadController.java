...
public class UploadController {
    ...
    public R upload(@RequestParam("file") MultipartFile file) throws Exception {
        ...
        String url = "https://" + config.getAliyunBucketName() + "." + config.getAliyunEndPoint() + "/" + filename.substring(filename.lastIndexOf("\\") + 1);
        return R.ok(url);
    }
    ...
    public R test(@RequestParam("file") MultipartFile file) throws Exception {
        ...
        String url = "https://" + config.getAliyunNuoeePrivateBucketName() + "." + config.getAliyunEndPoint() + "/" + filename.substring(filename.lastIndexOf("\\") + 1);
        return R.ok(url);
    }
