...
import org.springblade.core.tool.config.MessageConfiguration;
...
import org.springblade.order.jackson.OverrideMappingApiJackson2HttpMessageConverter;
 ...
 */
@Configuration
@AutoConfigureAfter(MessageConfiguration.class)
