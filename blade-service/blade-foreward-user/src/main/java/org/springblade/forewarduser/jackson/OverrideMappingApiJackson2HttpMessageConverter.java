package org.springblade.forewarduser.jackson;
 ...
 * @author L.cm
 */
public class OverrideMappingApiJackson2HttpMessageConverter extends AbstractReadWriteJackson2HttpMessageConverter {

    @Nullable
    private String jsonPrefix;

    /**
     * Construct a new {@link org.springblade.core.tool.jackson.MappingApiJackson2HttpMessageConverter} using default configuration
     * provided by {@link Jackson2ObjectMapperBuilder}.
     */
    public OverrideMappingApiJackson2HttpMessageConverter() {
        this(Jackson2ObjectMapperBuilder.json().build());
    }

    /**
     * Construct a new {@link org.springblade.core.tool.jackson.MappingApiJackson2HttpMessageConverter} with a custom {@link ObjectMapper}.
     * You can use {@link Jackson2ObjectMapperBuilder} to build it easily.
     * @param objectMapper ObjectMapper
     * @see Jackson2ObjectMapperBuilder#json()
     */
    public OverrideMappingApiJackson2HttpMessageConverter(ObjectMapper objectMapper) {
